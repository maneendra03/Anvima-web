      ...
      <div className="flex flex-col sm:flex-row sm:items-center sm:justify-between gap-4">
        ...
        <div className="flex items-center gap-3">
          ...
          <button
            onClick={handleSave}
            disabled={saving}
            className="inline-flex items-center gap-2 px-5 py-2.5 bg-gradient-to-r from-forest to-forest/80 text-white rounded-xl hover:from-forest/90 hover:to-forest/70 transition-all shadow-lg shadow-forest/25 font-medium disabled:opacity-50"
          >
            {saving ? (
