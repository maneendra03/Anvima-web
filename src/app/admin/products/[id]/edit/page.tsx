    ...
    try {
      ...
      if (data.success) {
        ...
        setFormData({
          ...
          allowText: product.customizationOptions?.allowText || false,
          maxTextLength: product.customizationOptions?.maxTextLength?.toString() || '50',
          allowImage: product.customizationOptions?.allowImage || false,
          maxImages: product.customizationOptions?.maxImages?.toString() || '1'
        })
