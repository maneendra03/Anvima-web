  ...
  return (
    <section className="relative min-h-screen flex items-center gradient-hero overflow-hidden">
      ...
      <div className="absolute inset-0 overflow-hidden">
        <div className="absolute top-20 left-10 w-72 h-72 bg-peach-200/30 rounded-full blur-3xl" />
        <div className="absolute bottom-20 right-10 w-96 h-96 bg-blush-200/20 rounded-full blur-3xl" />
        <div className="absolute top-1/2 left-1/2 -translate-x-1/2 -translate-y-1/2 w-[600px] h-[600px] bg-cream-200/20 rounded-full blur-3xl" />
      </div>
        ...
        <div className="grid lg:grid-cols-2 gap-12 items-center">
          ...
          >
            <motion.div
              ...
              className="inline-flex items-center gap-2 px-4 py-2 bg-peach-100 rounded-full text-peach-600 text-sm font-medium mb-6"
            >
              <Sparkles className="w-4 h-4" />
              Handcrafted with Love
            </motion.div>

            <h1 className="text-4xl sm:text-5xl lg:text-6xl font-serif font-bold text-charcoal-700 leading-tight mb-6">
              Create Memories{' '}
            ...
            <p className="text-lg text-charcoal-500 mb-8 max-w-lg mx-auto lg:mx-0">
            ...
            <motion.div
              ...
              className="mt-10 flex items-center gap-8 justify-center lg:justify-start text-sm text-charcoal-500"
            >
