          ...
          >
            ...
            <div className="flex gap-2">
              <input
                ...
                className={`flex-1 px-4 py-2.5 border rounded-lg focus:ring-2 focus:ring-forest-500 focus:border-forest-500 transition-colors uppercase ${
              ...
              <motion.button
                ...
                className="px-4 py-2.5 bg-forest-600 text-white rounded-lg font-medium hover:bg-forest-700 transition-colors disabled:opacity-50 disabled:cursor-not-allowed flex items-center gap-2"
              >
                {loading ? (
